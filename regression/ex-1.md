...
## 1. Purpose
The purpose of training a model on the X dataset is to predict the .... 

## 2. Dataset
The Data Set Data Set consist of .... The resulting training and test sets for both features and targets are stored in separate variables:
...
* ### 13 AUGUST 2023: Check out my [NOTEBOOK ON GOOGLE COLAB](link). This notebook demonstrates ...
